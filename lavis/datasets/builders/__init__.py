...
def load_dataset(name, cfg_path=None, pts_path=None, data_type=None):
    ...
    if cfg_path is None:
        ...
        cfg, whole_cfg = load_dataset_config(cfg_path)
    ...
    our_cfg = whole_cfg.ours
    assert our_cfg is not None, "Please provide our config in the main config file."
    
    dataset = builder.build_datasets(our_cfg=our_cfg)
    return dataset
